...
const ScrollHorizontalExamplesPanel = observer(function ScrollHorizontalExamplesPanel() {
...
const ToolbarExamplesPanel = observer(function ToolbarExamplesPanel() {
  const store = useMemo(() => createStoreToolbarExample(), []);
  const toolbarEventHandle = (toolbarId) => (eventType, eventData) => store.handleEvent(eventType, { ...eventData, toolbarId });
  const actionAdd = (actionText) => store.handleEvent('actionAdd', { actionText });
  ...
  return (
    <div className="toolbar-demo">
      <section className="toolbar-demo-panel is-narrow" aria-label="Dense toolbar example">
        ...
        <Toolbar
          data={{
            scrollLeft: store.toolbarStateById.dense.scrollLeft,
            groupList: [
              {
                id: 'edit',
                labelText: 'Edit',
      ...
      <section className="toolbar-demo-panel is-narrow" aria-label="Compact toolbar example">
        ...
        <Toolbar
          data={{
            scrollLeft: store.toolbarStateById.compact.scrollLeft,
            groupList: [
              {
                id: 'quick-edit',
      ...
      <section className="toolbar-demo-panel is-narrow" aria-label="Toolbar with content aside example">
        ...
        <Toolbar
          data={{
            scrollLeft: store.toolbarStateById.aside.scrollLeft,
            groupList: [
              {
                id: 'layout',
                labelText: 'Layout',
      ...
      <section className="toolbar-demo-panel is-narrow" aria-label="Toolbar with bottom labels example">
        ...
        <Toolbar
          data={{
            scrollLeft: store.toolbarStateById.edge.scrollLeft,
            groupList: [
              {
                id: 'page-left',
                labelText: 'Page',
      ...
      <section className="toolbar-demo-panel is-narrow" aria-label="Thin toolbar example">
        ...
        <Toolbar
          data={{
            scrollLeft: store.toolbarStateById.thin.scrollLeft,
            groupList: [
              {
                id: 'thin-edit',
      ...
      <div className="toolbar-demo-log" aria-label="Recent toolbar actions">
        {store.actionLogList.length ? store.actionLogList.map((logItem) => <span key={logItem.id}>{logItem.text}</span>) : <span>No actions yet</span>}
      </div>
    </div>
  );
});
...
const LayoutToolbarExamplesPanel = () => (
  <div className="toolbar-demo">
    <div className="toolbar-demo-panel-title">Scrollable toolbar layout built on horizontal wheel scrolling.</div>
    <TabsOnTop defaultTab="ScrollHorizontal" defaultKeepMounted={false}>
      <TabsOnTop.Tab label="ScrollHorizontal">
        <ScrollHorizontalExamplesPanel />
      </TabsOnTop.Tab>
      <TabsOnTop.Tab label="Toolbar">
        <ToolbarExamplesPanel />
      </TabsOnTop.Tab>
    </TabsOnTop>
  </div>
);
