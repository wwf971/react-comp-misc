...
export interface TableManageProps {
  tableName: string
  description: string
  ...
  showHowToCreate?: boolean  // Show "How to Create" button regardless of table status
}
    ...
    <div className="table-card">
      ...
      <div className="table-card-actions">
        {exists === null ? (
          ...
          // Table exists - show "How to create" (if enabled), "How to empty" and "How to delete" buttons
          <>
            {showHowToCreate && (
              <button onClick={toggleCreateSQL} className="btn-how-to-create">
                {showCreateSQL ? 'Hide SQL' : 'How to Create'}
      ...
      {showCreateSQL && (exists === false || showHowToCreate) && (
