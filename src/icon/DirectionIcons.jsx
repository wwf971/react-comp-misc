...
const UpDownIcon = React.memo(({ width = 24, height = 24 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
const ChevronUp = UpIcon;
const ChevronDown = DownIcon;
const ChevronLeft = LeftIcon;
const ChevronRight = RightIcon;
const ChevronUpDown = UpDownIcon;
